		...
		while (!sair) {
			...
			case 2:
				...
				while (!semNome) {
					...
					try {
						System.out.println(posicao2 + 1 + "° Nome: " + cliente.getNomes(posicao2)
								+ ", Seu destino é para " + cliente.getDestino(posicao2));
			...
			case 4:
				...
				while (!semPacotes) {
					...
					try {
						System.out.println(posicao3 + 1 + "° Pacote: " + pacotes.getLocais(posicao3) + ", Seu preço é "
								+ pacotes.getPrices(posicao3));
					} catch (IndexOutOfBoundsException exeption) {
						System.out.println("");
						System.out.println("============!!===========");
